...
class CommonAssetsModel(CommonBaseModel):
    ...
    asset_account=models.ForeignKey(CommonChartofAccountsModel, blank=True, null=True,on_delete=models.SET_NULL,related_name='cmassetrl')
    cost_account=models.ForeignKey(CommonChartofAccountsModel, blank=True, null=True,on_delete=models.SET_NULL,related_name='cstasschac')
    ...
    value=models.DecimalField(max_digits=30,blank=True,null=True,decimal_places=1,default=0)
