...
class CommonCompanyScopeModel(models.Model):# this is the company  hospitality logistics
    ...
    date=models.DateField(blank=True,null=True,auto_now_add=True)
    company= models.ForeignKey(CommonCompanyDetailsModel,related_name="compscopesconn",on_delete=models.SET_NULL,null=True,blank=True)
    def __str__(self):
        return self.name
...
class CommonBankWithdrawalsModel(models.Model):
    ...
    company= models.ForeignKey(CommonCompanyDetailsModel,related_name="withcmprlnm",on_delete=models.SET_NULL,null=True,blank=True)
    date=models.DateField(blank=True,null=True,auto_now_add=True)
    ...
    #supplier= models.ForeignKey(CommonSuppliersModel,related_name="withdrwrlnm",on_delete=models.SET_NULL,blank=False,null=True)
...
class CommonEmailsModel(models.Model):
    subject=models.CharField(max_length=300,blank=False,null=True)
...
class CommonSupplierPaymentsModel(models.Model):
    ...
    company= models.ForeignKey(CommonCompanyDetailsModel,related_name="cmpsupym",on_delete=models.SET_NULL,null=True,blank=True)
...
class CommonSupplierStatementsModel(models.Model):
    ...
    company= models.ForeignKey(CommonCompanyDetailsModel,related_name="cmpsplst",on_delete=models.SET_NULL,null=True,blank=True)
...
class CommonFormsModel(models.Model):
    ...
    company= models.ForeignKey(CommonCompanyDetailsModel,related_name="cmnfrmcmp",on_delete=models.SET_NULL,null=True,blank=True)
    date=models.DateField(auto_now=True)
    comments=models.CharField(max_length=30,blank=True,null=True, default='comment')
...
class CommonClassesModel(models.Model):
    ...
    department= models.ForeignKey(CommonDepartmentsModel,related_name="dptclss",on_delete=models.SET_NULL,null=True,blank=True)
...
class CommonCustomersModel(models.Model):
    ...
    name = models.CharField(null=True, blank=False, max_length=20)#customer, student, patient---can be entity/person
    phone = models.CharField(null=True, blank=True, max_length=30)
    email= models.CharField(null=True, blank=True, max_length=100)
    city= models.CharField(null=True, blank=True, max_length=30)
    address = models.CharField(null=True, blank=True, max_length=30)
    ...
    company= models.ForeignKey(CommonCompanyDetailsModel,related_name="cmncmprnm",on_delete=models.SET_NULL,null=True,blank=True)
    ...
    paymentType= models.CharField(choices=payment_method,default="Cash",max_length=30)
...
class CommonCustomerPaymentsModel(models.Model):
    ...
    company= models.ForeignKey(CommonCompanyDetailsModel,related_name="cmpcspymnt",on_delete=models.SET_NULL,null=True,blank=True)
...
class CommonCustomerStatementsModel(models.Model):
    ...
    company= models.ForeignKey(CommonCompanyDetailsModel,related_name="cmpcstsmnreln",on_delete=models.SET_NULL,null=True,blank=True)
...
class CommonLedgerEntriesModel(models.Model):
    ...
    company= models.ForeignKey(CommonCompanyDetailsModel,related_name="cmpyldgentr",on_delete=models.SET_NULL,null=True,blank=True)
...
class CommonAssetCategoriesModel(models.Model):
    ...
    company= models.ForeignKey(CommonCompanyDetailsModel,related_name="cmpasstcatasst",on_delete=models.SET_NULL,null=True,blank=True)
...
class CommonAssetsModel(models.Model):
    ...
    company= models.ForeignKey(CommonCompanyDetailsModel,related_name="cmncmpassetrln",on_delete=models.SET_NULL,null=True,blank=True)
    ...
    terms= models.CharField(choices=payment_method, max_length=20,blank=False)
...
class CommonExpensesModel(models.Model):
    ...
    company= models.ForeignKey(CommonCompanyDetailsModel,related_name="cmnexpcmpn",on_delete=models.SET_NULL,null=True,blank=True)
...
class CommonStocksModel(models.Model):
    ...
    company= models.ForeignKey(CommonCompanyDetailsModel,related_name="cmnestkmpn",on_delete=models.SET_NULL,null=True,blank=True)
...
class CommonPurchaseOrderItemsModel(models.Model):
    ...
    def purchase_order_amount(self):
        #po_amount=self.quantity * self.items.unitPrice
