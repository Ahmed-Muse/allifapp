...
class FlightsModel(CommonBaseModel):
    ...
    ticket_price=models.DecimalField(max_digits=30,blank=False,null=True,decimal_places=2,default=0.00)
    tax_amount=models.DecimalField(max_digits=30,blank=False,null=True,decimal_places=2,default=0)
    ...
    flight_capacity=models.IntegerField(blank=False,null=True,default=0)
    seats_available=models.IntegerField(blank=False,null=True,default=0)
    seats_booked=models.IntegerField(blank=False,null=True,default=0)
...
class TicketsModel(CommonBaseModel):
    ...
    price=models.DecimalField(max_digits=30,blank=False,null=True,decimal_places=2,default=0.00)
    tax_amount=models.DecimalField(max_digits=30,blank=False,null=True,decimal_places=2,default=0)
    total_amount=models.DecimalField(max_digits=30,blank=False,null=True,decimal_places=2,default=0)
